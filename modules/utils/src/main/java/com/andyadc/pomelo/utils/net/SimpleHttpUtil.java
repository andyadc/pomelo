package com.andyadc.pomelo.utils.net;

import com.andyadc.pomelo.utils.StringUtil;
import com.andyadc.pomelo.utils.collection.MapUtil;
...
public final class SimpleHttpUtil {
    ...
    static {
        DEFAULT_HEADER.put("User-Agent", "Pomelo-Http");
